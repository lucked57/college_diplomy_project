...
if( isset( $_POST['image'] ) ){  
   ...
   // $ios = $_COOKIE['ios'];
    ...
    $Select_messenge = new Select();
      ...
      $table_name_messenge = 'teatchers_anketa';
  ...
  $errors = "неподдерживаемый формат";
            ...
            do {
              ...
              if($file['size']>500000){
               ...
               $percent = 0.5;
                ...
                $file_name = $Generate_code->generate_code_for_cokie(97);
        ...
        if( move_uploaded_file( $file['tmp_name'], "$uploaddir/$file_name" ) ){
            ...
            $Update->update_where("teatchers_anketa","img_uploads_dir", $full_dir, "login", $login);
            
            $Update->update_where("teatchers_anketa","img_anketa", $dir_img, "login", $login);
        }
    }
        else{
            ...
            if(empty($check_img_update['img_anketa'])){
                            ...
                            $delete = new Delete;
            $delete->get_delete_where('teatchers_anketa','login',$login);
