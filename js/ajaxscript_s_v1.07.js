...
function Check_anketa_s(){

    if($('#info_anketa p:last-child').text() == 'У вас не заполнена анкета'){
          $(".messenge_href5 p").html('У вас не заполнена анкета, чтобы ее заполнить перейдите в соотвествующий пункт меню или нажмите на это собщение');
	...
	files_add = this.files;
			...
			if( typeof respond.error === 'undefined' ){
                ...
                */
                ...
                if(update == 'true'){
                $('.messenge p').html('Анкета успешно обновлена');
                $(".messenge").animate({ opacity: 'toggle',  top: 'toggle' }, 600);
                }
                else{
                    $('.messenge_href5 p').html("Анкета успешно заполнена, чтобы добавить достижение перейдите в соотвествующий пункт меню или нажмите на это сообщение");
                $(".messenge_href5").animate({ opacity: 'toggle',  top: 'toggle' }, 600);
                }
          ...
          $("#do_achivka_add, #form_add_achivka").on("submit", function(){
             ...
             var title_add = $("#title_achivka").val();
              ...
              if(textarea_add.trim().length>5000){
               ...
               if(title_add.indexOf('<')!= -1 || title_add.indexOf('>')!= -1 || title_add.indexOf('"')!= -1 || title_add.indexOf("'")!= -1 || textarea_add.indexOf('<')!= -1 || textarea_add.indexOf('>')!= -1 || textarea_add.indexOf('"')!= -1 || textarea_add.indexOf("'")!= -1 ){
                  errors = "Содержаться недопустимые символы";
              }
